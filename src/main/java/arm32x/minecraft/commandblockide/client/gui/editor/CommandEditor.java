...
import arm32x.minecraft.commandblockide.client.processor.CommandAutoFormatter;
...
public abstract class CommandEditor extends Container implements Dirtyable {
	...
	public void autoFormat(){
		String newCmd = CommandAutoFormatter.getInstance().format(getSingleLineCommand());
